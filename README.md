...
```
 ...
 Stage 2: PROCESS        N workers × BlockProcessor
                          Validator: BlockValidator backend (default: MegaEvmValidator)
...
| `crates/stateless-core/src/executor.rs`                                                        | Block validation and EVM replay; `BlockValidator` executor seam                     |
