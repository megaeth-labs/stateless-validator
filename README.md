...
The band is measured against the chain head this process has observed, not against how far it has ingested, so a catch-up no longer routes genuine holes in the gap away from the alarm.
